...
tl;dr: currying and partial application in JavaScript is useful to make small, simple functions you can compose together for complex (but maintainable) logic.
eg. ```
    const add = x => y => x + y
    const add2 = add(2)
